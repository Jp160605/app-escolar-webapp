...
import { RegistroMateriaComponent } from './partials/registro-materias/registro-materias.component';
import { RegistroMateriaScreenComponent } from './screens/registro-materia/registro-materia.component';
...
const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'materias/registrar/:id', component: RegistroMateriaScreenComponent },
      { path: 'materias/registrar', component: RegistroMateriaScreenComponent },
